...
<div class='row'>    
      <?php
      $query="SELECT *  FROM shirts WHERE shirt_cat='Women' ";
      $shirt_women=mysqli_query($connection,$query);
      $numrows=mysqli_num_rows($shirt_women);
      while($row = mysqli_fetch_assoc($shirt_women)) {
            $id            = $row['shirt_id'];
